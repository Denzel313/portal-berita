        ...
        <div class="row">
            <div class="col-lg-8">
                                        ...
                                        <div class="col-xl-6 col-lg-12">
                                            <div class="whats-news-single mb-40 mb-40">
                                                ...
                                                <div class="whates-caption">
                                                    ...
                                                    <span>{{ $post->author }} - {{ $post->created_at->isoFormat('dddd, D MMMM Y') }}</span>
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                    <div class="whats-right-single mb-20">
                                                        ...
                                                        <div class="whats-right-cap">
                                                            ...
                                                            <h4><a href="latest_news.html">{{ Str::words($post->news_content, 5) }}</a></h4>
                ...
                <div class="banner-one mt-20 mb-30">
                    <img src="{{ asset('style/assets/img/gallery/body_card1.png') }}" alt="">
                </div>
            </div>
            <div class="col-lg-4">
                <!-- Most Recent Area -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="weekly2-news-active d-flex">
                                    ...
                                    <div class="weekly2-single">
                                        <div class="weekly2-img">
                                            <img src="{{ asset('style/assets/img/gallery/weeklyNews2.png') }}" alt="">
                                        </div>
                                        <div class="weekly2-caption">
                                            <h4><a href="#">Scarlett’s disappointment at latest accolade</a></h4>
                                            <p>Jhon | 2 hours ago</p>
                                    ...
                                    <div class="weekly2-single">
                                        <div class="weekly2-img">
                                            <img src="{{ asset('style/assets/img/gallery/weeklyNews3.png') }}" alt="">
                                        </div>
                                        <div class="weekly2-caption">
                                            <h4><a href="#">Scarlett’s disappointment at latest accolade</a></h4>
                                            <p>Jhon | 2 hours ago</p>
